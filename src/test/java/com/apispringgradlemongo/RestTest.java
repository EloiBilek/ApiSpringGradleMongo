 ...
 * 
 */
package com.apispringgradlemongo;
...
public class RestTest {
	...
	private static String URL_TEST = "http://localhost:8080/ApiSpringGradleMongo/v1/users";
	...
	public void a_postTest() {
		...
		user.setEmail("testeJunitSpringPost@test.com");
		user.setActive(true);
		...
		assertTrue(!userCreated.getId().equals(""));
	...
	public void c_putTest() {
		...
		user.setDateBirth(new Date());
		user.setEmail("testeJunitSpringPut@test.com");
		user.setActive(true);
		...
		assertTrue(!userUpdated.getId().equals(""));
